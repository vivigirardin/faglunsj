...
__**Shiny**__
SQL is based on the analysis report. The sample must have a station linked to it to ensure that only projects that are available in AquaMonitor are available in the dashboard.
Username and password are stored in the Renviron.
